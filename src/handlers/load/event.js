...
module.exports = (client) => {
    fs.readdirSync('./src/events').forEach(dirs => {
        ...
        if (client.shard.ids[0] === 0) console.log(chalk.magenta(chalk.bold(`Hexify`)), (chalk.white(`|`)), chalk.red(`${events.length}`), (chalk.green(`events of`)), chalk.red(`${dirs}`), (chalk.green(`loaded`)));
