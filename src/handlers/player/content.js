                    ...
                    case "sstop":
                        {
                            if (!channel) {
                                ...
                                const embed = new EmbedBuilder()
                                    .setDescription(`${client.emotes.CROSS} » **Left:** • \`${memberVoice.name}\``)
                                    .setColor(client.config.EMBED_COLOR)
                    ...
                    case "spause":
                        {
                            if (!channel) {
                                ...
                                const embed = new EmbedBuilder()
                                    .setColor(client.config.EMBED_COLOR)
                                    .setDescription(`${client.emotes.TICK} » **Song has been:** \`Resumed\``);
                                ...
                                const embed = new EmbedBuilder()
                                    .setColor(client.config.EMBED_COLOR)
                                    .setDescription(`${client.emotes.TICK} » **Song has been:** \`Paused\``);
                    ...
                    case "sloop":
                        {
                            if (!channel) {
                                ...
                                const embed = new EmbedBuilder()
                                    .setColor(client.config.EMBED_COLOR)
                                    .setDescription(`${client.emotes.REFRESH} » **Loop disabled**`)
                                ...
                                const embed = new EmbedBuilder()
                                    .setColor(client.config.EMBED_COLOR)
                                    .setDescription(`${client.emotes.REFRESH} » **Loop enabled** `)
